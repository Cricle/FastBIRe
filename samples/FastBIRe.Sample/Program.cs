    ...
    internal class Program
    {
        ...
        static TableColumnDefine[] GetDestDefine(SourceTableColumnBuilder builder)
        {
            var defs = new TableColumnDefine[]
            {
                ...
                builder.Column("111aaaa7777",type:builder.Type(DbType.String,255),length:255),
        ...
        static SourceTableColumnDefine[] GetSourceDefine(SourceTableColumnBuilder builder)
        {
            var defs = new SourceTableColumnDefine[]
            {
                ...
                builder.Method("a7","111aaaa7777", ToRawMethod.Minute,true,type:builder.Type(DbType.DateTime),destFieldType:builder.Type(DbType.String, 255),length:9999,destLength:9999),
